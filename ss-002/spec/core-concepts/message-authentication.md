...
- [Formal Specification, Section 5](../SPEC.md#5-authentication-and-message-security)
- [Guide: Connect and Authenticate](../guides/connect-and-authenticate.md)
- [SS-SPEC-001, Section 6 — Cryptographic Conventions](../../ss-001/SPEC.md#6-cryptographic-conventions)
