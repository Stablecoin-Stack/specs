...
Within SS-SPEC-001's component model, the wallet-gateway is one of four components in the Broadcast Layer:
...
- [SS-SPEC-001, Section 5.3 — Broadcast Layer](../../ss-001/SPEC.md#53-broadcast-layer)
