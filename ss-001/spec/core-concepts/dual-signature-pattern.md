---
document: SS-SPEC-001/core-concepts/dual-signature-pattern.md
spec: SS-SPEC-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
- [Formal Specification, Section 6.1](../SPEC.md#61-two-signature-pattern) — normative definition
- [Formal Specification, Section 8](../SPEC.md#8-dual-signature-pattern) — on-chain implementation
- [Security Model](../SPEC.md#11-security-model) — threat model and mitigations
