---
document: SS-SPEC-001/core-concepts/payment-flow.md
spec: SS-SPEC-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
This document describes the complete end-to-end payment flow — from charge creation by the merchant to final settlement confirmation delivered to both merchant and payer. It is written as a narrative to build intuition. Normative requirements for each step are in the [formal specification](../SPEC.md).
...
- [Formal Specification, Section 10](../SPEC.md#10-end-to-end-payment-flow) — normative flow
