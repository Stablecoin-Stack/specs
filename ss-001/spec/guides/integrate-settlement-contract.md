---
document: SS-SPEC-001/guides/integrate-settlement-contract.md
spec: SS-SPEC-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
It has no upgrade mechanism. Its administrative functions are restricted to fee parameters and the fee recipient address. It cannot be used to drain participant funds. See [Security Model](../SPEC.md#18-security-model) for the full administrative privilege boundaries.
...
- [Security Model](../SPEC.md#18-security-model) — administrative privilege boundaries
- [Formal Specification, Sections 10–13](../SPEC.md#10-settlement-contract--state-variables) — normative contract requirements
