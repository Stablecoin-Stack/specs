---
document: SS-SPEC-001/reference/payload-fields.md
spec: SS-SPEC-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
Flat field-level reference for all structures and payload types. For normative rules see [SS-SPEC-001, Sections 7–8](../SPEC.md#7-data-structures).
