---
document: SS-SPEC-001/reference/component-index.md
spec: SS-SPEC-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
Authoritative reference for all components of the Stablecoin Stack. For normative requirements see [SS-SPEC-001, Section 5](../SPEC.md#5-component-specifications).
...
The following components require dedicated interface specifications, planned as future companion specs to SS-SPEC-001:

| Component | Planned Spec |
| --------- | ------------ |
| core-checkout-engine (merchant API) | SS-SPEC-002 |
| wallet-gateway (WebSocket protocol) | SS-SPEC-003 |
| wallet-gateway (interface) | SS-SPEC-004 |
| broadcast-service (interface) | SS-SPEC-005 |
| broadcast-submitter (interface) | SS-SPEC-006 |
| transfer-history (interface) | SS-SPEC-007 |
| basic-data-server (interface) | SS-SPEC-008 |
| Client Wallet (certification) | SS-SPEC-009 |
