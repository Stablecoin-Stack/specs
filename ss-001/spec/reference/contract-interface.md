---
document: SS-SPEC-001/reference/contract-interface.md
spec: SS-SPEC-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
Flat technical reference for all state variables, functions, and events of the Settlement Contract. For normative definitions see [SS-SPEC-001, Sections 10–13](../SPEC.md#10-settlement-contract--state-variables).
