...
description: The normative Stablecoin Stack specification — (SS-001). 
document: stablecoin-stack/ss-001/SPEC.md
spec: FPSF-SS-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
# FPSF-SS-001 — The Stablecoin Stack
> **Version**: 1.0.0
>
> **Supersedes**: SS-SPEC-000, FPSF-SS-001 (pre-unification), SS-SPEC-002 (pre-unification)  
> 
---
...
This is the single authoritative specification for the Stablecoin Stack. It supersedes the pre-unification documents SS-SPEC-000, the pre-unification FPSF-SS-001, and SS-SPEC-002. Future companion specifications covering individual component interfaces will reference this document.
...
| Planned ID | Subject |
| ---------- | ------- |
| SS-SPEC-002 |wallet-gateway Interface |
| SS-SPEC-003 | Broadcast Layer Protocol — WebSocket protocol between wallet and wallet-gateway |
| SS-SPEC-004 |  Checkout Engine API — merchant-facing session and charge management |
| SS-SPEC-005 | broadcast-service Interface |
| SS-SPEC-006 | broadcast-submitter Interface |
| SS-SPEC-007 | transfer-history Interface |
| SS-SPEC-008 | basic-data-server Interface |
| SS-SPEC-009 | Client Wallet Certification |
...
All future companion specifications MUST declare the version of FPSF-SS-001 to which they conform.
...
| ------- | ---- | ------ | ------- |
| 1.0.0 | 2026-03-04 | Adalton Reis | Initial release. Unification of SS-SPEC-000 (system overview), pre-unification FPSF-SS-001 (submission protocol), and SS-SPEC-002 (Settlement Contract) into a single specification under the Layered Docs structure. |

---

## 23. License

Copyright © 2026 Fabrc Payment Standards Foundation. All rights reserved.
