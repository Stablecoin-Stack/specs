---
document: SS-SPEC-001/overview/introduction.md
spec: SS-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
**Auditors** assessing cryptographic correctness, security model, or protocol conformance should go directly to the [formal specification](../SPEC.md), paying particular attention to Sections 11 (Security Model) and 12 (Conformance). The [normative references](../reference/normative-references.md) list all cited standards.
...
- [Formal Specification — SS-SPEC-001](../SPEC.md)
