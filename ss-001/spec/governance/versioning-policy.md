---
document: SS-SPEC-001/governance/versioning-policy.md
spec: SS-SPEC-001
version: 1.0.0
status: Draft
date: 2026-03-04
...
The Stablecoin Stack specification (SS-SPEC-001) follows [Semantic Versioning 2.0.0](https://semver.org).
...
All companion specifications (SS-SPEC-002 and above) MUST declare the version of SS-SPEC-001 to which they conform using the `conformsTo` field in their identity table.

When a companion specification is published, SS-SPEC-001 receives a MINOR version increment and the companion specification is added to the conformance registry in Section 19.3 of the formal specification.
...
SS-SPEC-001 is currently at version **1.0.0**. For a history of changes see [changelog.md](./changelog.md).
